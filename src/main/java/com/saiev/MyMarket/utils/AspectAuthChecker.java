...
public class AspectAuthChecker {
    ...
    @Around("execution(public * com.saiev.MyMarket.services.ProductService.saveProduct(..))")
    ...
    @Before("execution(public void com.saiev.MyMarket.services.ShoppingCartService.AddToCart(..))")
